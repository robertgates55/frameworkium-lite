...
public class TheInternetExampleTests extends BaseUITest {
    ...
    public void check_boxes_can_all_be_checked() {
        ...
        int timeout = 15;
        List<Boolean> checkboxesStatus = WelcomePage.open(timeout)
                .clickCheckboxesLink()
                .checkAllCheckboxes()
    ...
    public void javascriptAlerts() {
        ...
        var javascriptAlerts =
                WelcomePage.open().clickJavascriptAlertsLink().clickAlertButtonAndAccept();
    ...
    public void sortDataTable() {
        ...
        assertThat(tablesPage.getTable1ColumnContents("Web Site")).contains("http://www.jdoe.com");
