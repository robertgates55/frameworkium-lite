...
public abstract class AbstractStreamTable extends HtmlElement {
     ...
     *         {@code targetHeaderMatcher} which matches {@code lookupCellMatcher}
    ...
    public Stream<WebElement> getCellsByLookup(
        ...
        return getCellsByLookupAndIndex(lookupCellMatcher, lookupColumnIndex, targetColumnIndex);
    }
     ...
     *                          identified by {@code lookupHeaderMatcher} in the
     *                          column identified by {@code targetHeaderMatcher}
     * @param lookupColumnIndex the index of the column to use as a lookup
     * @param targetColumnIndex the index of the column to return cells
     *                          based upon the lookup
     * @return {@link WebElement}s from the column matched by
     *         {@code targetColumnIndex} which matches {@code lookupCellMatcher}
     *         in {@code lookupColumnIndex}
     */
    @SuppressWarnings("UnstableApiUsage")
    public Stream<WebElement> getCellsByLookupAndIndex(
            Predicate<WebElement> lookupCellMatcher,
            long lookupColumnIndex,
            long targetColumnIndex) {
